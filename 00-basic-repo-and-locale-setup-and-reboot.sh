...
apt -y  install vim chrony openssh-server locales screen net-tools git mc  \
sudo wget curl ethtool iptraf-ng traceroute telnet software-properties-common \
...
gnupg2 zip tar pv rar unrar rsync unzip 
